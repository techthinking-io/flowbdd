...
description = "Method validation annotations for flowbdd"
...
publishing {
    publications {
        create<MavenPublication>("mavenJava") {
            ...
            pom {
                name.set("flowbdd-validate")
                description.set("Method validation annotations for flowbdd")

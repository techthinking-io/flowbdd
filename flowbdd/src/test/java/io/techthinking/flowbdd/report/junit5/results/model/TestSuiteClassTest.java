...
class TestSuiteClassTest {
    ...
    void setsFullyQualifiedName() {
        assertThat(testSuiteClass.getFullyQualifiedName()).isEqualTo("io.techthinking.flowbdd.report.junit5.results.model.TestSuiteClassTest");
    }
    ...
    void setsPackageName() {
        assertThat(testSuiteClass.getPackageName()).isEqualTo("io.techthinking.flowbdd.report.junit5.results.model");
    }
}